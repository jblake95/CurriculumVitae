...
\personalinfo{%
  ...
  \rgate{\href{https://www.researchgate.net/profile/James-Blake-7}{researchgate/James-Blake-7}}
  \github{\href{https://github.com/jblake95}{github/jblake95}}
  \homepage{\href{https://warwick.ac.uk/fac/sci/physics/research/astro/people/jamesblake/}{warwick.ac.uk/astro/jamesblake}}
}
...
\smallskip
\begin{itemize}
	\item Visiting Ph.D. -- \textit{Wang (2025)} %\textit{Han Wang}
	\item M.Phys. -- \textit{Navas \& Higgins (2024), Roberts \& Manoharan (2018)} %\textit{Alex Navas \& Tom Higgins, Jonathan Roberts \& Aharan Manoharan}
	\item B.Sc. -- \textit{Elamin \& Singh (2019)} %\textit{Omar Elamin \& Toyaj Singh}
	\item UG Research Support Scheme -- \textit{Vallow (2024)} %\textit{Ben Vallow}
\end{itemize}
